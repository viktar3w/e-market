  ...
  return (
    ...
    >
      <span className="relative z-10 flex items-center gap-2">
        {children}{" "}
        <ArrowRight className="size-4 shrink-0 text-white transition-transform duration-300 easy-in-out group-hover:translate-x-[2px]" />
      </span>
      <div className="easy-[cubic-bezier(0.19,1,0.22,1)] absolute -left-[75px] -top-[50px] -z-10 h-[155px] w-8 rotate-[35deg] bg-white opacity-20 transition-all duration-500 group-hover:left-[120%]" />
    </Link>
  );
};
